...
export const selectFields: CollectionConfig['fields'] = [
  {
    ...
    admin: {
      components: {
        Field:
          '@/(payload)/collections/Fields/select/components/server/Field#CustomSelectFieldServer',
        Label:
          '@/(payload)/collections/Fields/select/components/server/Label#CustomSelectFieldLabelServer',
      },
    },
    options: [
      {
